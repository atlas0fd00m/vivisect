...
ppc_ops = (
  ...
  ( "addze"      , 0x7C000194, 0x7C000194 | F_MASK_XO  ,    F_XO,   INS_ADD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "addze."     , 0x7C000194, 0x7C000191 | F_MASK_XO  ,    F_XO,   INS_ADD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),
  ( "addzeo"     , 0x7C000194, 0x7C000594 | F_MASK_XO  ,    F_XO,   INS_ADD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "addzeo."    , 0x7C000194, 0x7C000595 | F_MASK_XO  ,    F_XO,   INS_ADD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),
  ...
  ( "subfze"     , 0x7C000190, 0x7C000190 | F_MASK_XO  ,    F_XO,   INS_SUB, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "subfze."    , 0x7C000190, 0x7C000191 | F_MASK_XO  ,    F_XO,   INS_SUB, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),
  ( "subfzeo"    , 0x7C000590, 0x7C000590 | F_MASK_XO  ,    F_XO,   INS_SUB, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "subfzeo."   , 0x7C000590, 0x7C000591 | F_MASK_XO  ,    F_XO,   INS_SUB, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),
  ...
  ( "wrteei"     , 0x7C000146, 0x7C000146 | F_MASK_X   ,     F_X,   INS_MOV, COND_AL, (TYPE_NONE, TYPE_NONE, TYPE_IMM, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ...
  ( "cmp"        , 0x7C000000, 0x7C000000 | F_MASK_CMP ,   F_CMP,   INS_CMP, COND_AL, (TYPE_CR, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "cmpl"       , 0x7C000040, 0x7C000040 | F_MASK_CMP ,   F_CMP,   INS_CMP, COND_AL, (TYPE_CR, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ...
  ( "extsb"      , 0x7C000774, 0x7C000774 | F_MASK_EXT ,   F_EXT,    INS_OR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "extsb."     , 0x7C000774, 0x7C000775 | F_MASK_EXT ,   F_EXT,    INS_OR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_RC),
  ( "extsw"      , 0x7C000734, 0x7C000734 | F_MASK_EXT ,   F_EXT,    INS_OR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "extsw."     , 0x7C000734, 0x7C000735 | F_MASK_EXT ,   F_EXT,    INS_OR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_RC),
  ...
  ( "isellt"     , 0x7C00001E, 0x7C00001E | F_MASK_X   ,     F_A,    INS_OR, COND_AL, (TYPE_NONE, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "iselgt"     , 0x7C00001E, 0x7C00005E | F_MASK_X   ,     F_A,    INS_OR, COND_AL, (TYPE_NONE, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "iseleq"     , 0x7C00001E, 0x7C00009E | F_MASK_X   ,     F_A,    INS_OR, COND_AL, (TYPE_NONE, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "isel"       , 0x7C00001E, 0x7C00001E | F_MASK_A   ,     F_A,    INS_OR, COND_AL, (TYPE_NONE, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lbepx"      , 0x7C0000BE, 0x7C0000BE | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lbzux"      , 0x7C0000AE, 0x7C0000AE | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lhaux"      , 0x7C0002EE, 0x7C0002EE | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lhax"       , 0x7C0002AE, 0x7C0002AE | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lhbrx"      , 0x7C00062C, 0x7C00062C | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lhepx"      , 0x7C00023E, 0x7C00023E | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lhzux"      , 0x7C00026E, 0x7C00026E | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lhzx"       , 0x7C00022E, 0x7C00022E | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ...
  ( "lwarx"      , 0x7C000028, 0x7C000028 | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lwarx."     , 0x7C000029, 0x7C000029 | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),
  ( "lwbrx"      , 0x7C00042C, 0x7C00042C | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lwepx"      , 0x7C00003E, 0x7C00003E | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lwzux"      , 0x7C00006E, 0x7C00006E | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lwzx"       , 0x7C00002E, 0x7C00002E | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),

  ( "lbzx"       , 0x7C0000AE, 0x7C0000AE | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "lbzux"      , 0x7C0000EE, 0x7C0000EE | F_MASK_X   ,     F_X,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),

  ( "stbx"       , 0x7C0001AE, 0x7C0001AE | F_MASK_X   ,     F_X, INS_STORE, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "stbux"      , 0x7C0001EE, 0x7C0001EE | F_MASK_X   ,     F_X, INS_STORE, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "sthx"       , 0x7C00032E, 0x7C00032E | F_MASK_X   ,     F_X, INS_STORE, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ...
  ( "stwx"       , 0x7C00012E, 0x7C00012E | F_MASK_X   ,     F_X, INS_STORE, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),

        # # 2584:	7c a7 e0 30 	slw     r7,r5,r28 */
  ( "slw"        , 0x7C000030, 0x7C000030 | F_MASK_X   ,     F_X,   INS_SHR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "slw."       , 0x7C000030, 0x7C000031 | F_MASK_X   ,     F_X,   INS_SHR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),
  ( "srw"        , 0x7C000430, 0x7C000430 | F_MASK_X   ,     F_X,   INS_SHR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "srw."       , 0x7C000430, 0x7C000431 | F_MASK_X   ,     F_X,   INS_SHR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),

  ( "sraw"       , 0x7C000630, 0x7C000630 | F_MASK_X   ,     F_X,   INS_SHR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "sraw."      , 0x7C000630, 0x7C000631 | F_MASK_X   ,     F_X,   INS_SHR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),
  ( "srawi"      , 0x7C000670, 0x7C000670 | F_MASK_X   ,     F_X,   INS_SHR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "srawi."     , 0x7C000670, 0x7C000671 | F_MASK_X   ,     F_X,   INS_SHR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE), IF_RC),
  ...
  ( "mfctr"      , 0x7C0902A6, 0x7C1902A6 | F_MASK_MTPR,  F_MTPR,   INS_MOV, COND_AL, (TYPE_NONE, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "mfspr"      , 0x7C0002A6, 0x7C0002A6 | F_MASK_MFPR,  F_MFPR,   INS_MOV, COND_AL, (TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "mtctr"      , 0x7C0903A6, 0x7C1903A6 | F_MASK_MTPR,  F_MTPR,   INS_MOV, COND_AL, (TYPE_NONE, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
...
e_ops = (
#  ( "name"       , op        , mask                    , type   ,   op_type           , COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG))
  ( "e_add16i"   , 0x1C000000, 0x1F000000 | E_MASK_D   , E_D    ,   INS_ADD, COND_AL, (TYPE_REG, TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ...
  ( "e_and2is."  , 0x7000E800, 0x7000E800 | E_MASK_I16L, E_I16LS,   INS_AND, COND_AL, (TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ...
  # has cr0-cr3 
  ( "e_bge"      , 0x7A000000, 0x7A000000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_GE, (TYPE_CR, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_ble"      , 0x7A000000, 0x7A010000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_LE, (TYPE_CR, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bne"      , 0x7A000000, 0x7A020000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_NE, (TYPE_CR, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bns"      , 0x7A000000, 0x7A030000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_VC, (TYPE_CR, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_blt"      , 0x7A000000, 0x7A100000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_LT, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  # 0x7a, 0x12, 0x01, 0x0a */
  ( "e_bgt"      , 0x7A000000, 0x7A110000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_GT, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_beq"      , 0x7A000000, 0x7A120000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_EQ, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bso"      , 0x7A000000, 0x7A130000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_VS, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  # this may not be correct
  ( "e_bc"       , 0x7A000000, 0x7A140000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_VS, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ...
  ( "e_blel"     , 0x7A000001, 0x7A010001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_LE, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bnel"     , 0x7A000001, 0x7A020001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_NE, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bnsl"     , 0x7A000001, 0x7A030001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_VC, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bltl"     , 0x7A000001, 0x7A110001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_LT, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bgtl"     , 0x7A000001, 0x7A120001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_GT, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_beql"     , 0x7A000001, 0x7A130001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_EQ, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bsol"     , 0x7A000001, 0x7A140001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_VS, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bcl"      , 0x7A000001, 0x7A140001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_VS, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  # has cr0-cr3  
  ( "e_bgectr"   , 0x7A000000, 0x7A200000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_GE, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_blectr"   , 0x7A000000, 0x7A210000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_LE, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bnectr"   , 0x7A000000, 0x7A220000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_NE, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bnsctr"   , 0x7A000000, 0x7A230000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_VC, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bltctr"   , 0x7A000000, 0x7A310000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_LT, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bgtctr"   , 0x7A000000, 0x7A320000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_GT, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_beqctr"   , 0x7A000000, 0x7A330000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_EQ, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bsoctr"   , 0x7A000000, 0x7A340000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_VS, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bcctr"    , 0x7A000000, 0x7A340000 | E_MASK_BD15, E_BD15 ,  INS_CJMP, COND_VS, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_BRANCH),
  ( "e_bgectrl"  , 0x7A000001, 0x7A200001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_GE, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_blectrl"  , 0x7A000001, 0x7A210001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_LE, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bnectrl"  , 0x7A000001, 0x7A220001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_NE, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bnsctrl"  , 0x7A000001, 0x7A230001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_VC, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bltctrl"  , 0x7A000001, 0x7A310001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_LT, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bgtctrl"  , 0x7A000001, 0x7A320001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_GT, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_beqctrl"  , 0x7A000001, 0x7A330001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_EQ, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bsoctrl"  , 0x7A000001, 0x7A340001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_VS, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ( "e_bcctrl"   , 0x7A000001, 0x7A340001 | E_MASK_BD15, E_BD15 , INS_CCALL, COND_VS, (TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE), IF_COND | IF_CALL),
  ...
  ( "e_cmpli"    , 0x1880A800, 0x1880A800 | E_MASK_SCI8, E_SCI8 ,   INS_CMP, COND_AL, (TYPE_CR, TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_IMM), IFLAGS_NONE),
  ( "e_cmpi"     , 0x1800A800, 0x1800A800 | E_MASK_SCI8, E_SCI8 ,   INS_CMP, COND_AL, (TYPE_CR, TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_IMM), IFLAGS_NONE),
  ...
  ( "e_li"       , 0x70000000, 0x70000000 | E_MASK_LI20, E_LI20 ,   INS_MOV, COND_AL, (TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_lis"      , 0x7000E000, 0x7000E000 | E_MASK_I16L, E_I16LS,   INS_MOV, COND_AL, (TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ...
  ( "e_mulli"    , 0x1800A000, 0x1800A000 | E_MASK_SCI8, E_SCI8 ,   INS_MUL, COND_AL, (TYPE_REG, TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_IMM), IFLAGS_NONE),
  ...
  ( "e_or2is"    , 0x7000D000, 0x7000D000 | E_MASK_I16L, E_I16LS,    INS_OR, COND_AL, (TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_ori"      , 0x1800D000, 0x1800D000 | E_MASK_SCI8, E_SCI8 ,    INS_OR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_IMM), IFLAGS_NONE),
  ( "e_ori."     , 0x1800D800, 0x1800D800 | E_MASK_SCI8, E_SCI8 ,    INS_OR, COND_AL, (TYPE_REG, TYPE_REG, TYPE_IMM, TYPE_IMM, TYPE_IMM), IF_RC),
  ...
  ( "e_stb"      , 0x34000000, 0x34000000 | E_MASK_D   , E_D    , INS_STORE, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_IMM, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
...
# e_stmvdsrrw 6 (0b0001_1000_110 RA 0b0001_0001 D8 */
  ( "e_ldmvgprw" , 0x18001000, 0x18001000 | E_MASK_D8  , E_D8   ,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_stmvgprw" , 0x18001100, 0x18001100 | E_MASK_D8  , E_D8   , INS_STORE, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_ldmvsprw" , 0x18201000, 0x18201000 | E_MASK_D8  , E_D8   ,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_stmvsprw" , 0x18201100, 0x18201100 | E_MASK_D8  , E_D8   , INS_STORE, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_ldmvsrrw" , 0x18801000, 0x18801000 | E_MASK_D8  , E_D8   ,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_stmvsrrw" , 0x18801100, 0x18801100 | E_MASK_D8  , E_D8   , INS_STORE, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_ldmvcsrrw", 0x18a01000, 0x18a01000 | E_MASK_D8  , E_D8   ,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_stmvcsrrw", 0x18a01100, 0x18a01100 | E_MASK_D8  , E_D8   , INS_STORE, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_ldmvdsrrw", 0x18c01000, 0x18c01000 | E_MASK_D8  , E_D8   ,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_stmvcsrrw", 0x18c01100, 0x18c01100 | E_MASK_D8  , E_D8   , INS_STORE, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
...
#  ( "name"      , op    , mask  , n,   op_type           , ((field ,shr,shl,  +, i, TYPE_REG_SE), ...)
  ...
  ( "se_lbz"    , 0x8000, 0x8FFF, 3,  INS_LOAD, COND_AL, ((0x0F00,  6,  0,  0, 2, TYPE_MEM), (0x00F0,  4,  0,  0,  0, TYPE_REG_SE), (0x000F,  0,  0,  0,  1, TYPE_MEM), (0), (0)), IFLAGS_NONE),
  ( "se_lhz"    , 0xA000, 0xAFFF, 3,  INS_LOAD, COND_AL, ((0x0F00,  6,  0,  0, 2, TYPE_MEM), (0x00F0,  4,  0,  0,  0, TYPE_REG_SE), (0x000F,  0,  0,  0,  1, TYPE_MEM), (0), (0)), IFLAGS_NONE),
  ( "se_li"     , 0x4800, 0x4FFF, 2,   INS_MOV, COND_AL, ((0x07F0,  4,  0,  0, 1, TYPE_IMM), (0x000F,  0,  0,  0,  0, TYPE_REG_SE), (0), (0), (0)), IFLAGS_NONE),
  ( "se_lwz"    , 0xC000, 0xCFFF, 3,  INS_LOAD, COND_AL, ((0x0F00,  6,  0,  0, 2, TYPE_MEM), (0x00F0,  4,  0,  0,  0, TYPE_REG_SE), (0x000F,  0,  0,  0,  1, TYPE_MEM), (0), (0)), IFLAGS_NONE),
  ...
  ( "se_stb"    , 0x9000, 0x9FFF, 3, INS_STORE, COND_AL, ((0x0F00,  6,  0,  0, 2, TYPE_MEM), (0x00F0,  4,  0,  0,  0, TYPE_REG_SE), (0x000F,  0,  0,  0,  1, TYPE_MEM), (0), (0)), IFLAGS_NONE),
  ( "se_sth"    , 0xB000, 0xBFFF, 3, INS_STORE, COND_AL, ((0x0F00,  6,  0,  0, 2, TYPE_MEM), (0x00F0,  4,  0,  0,  0, TYPE_REG_SE), (0x000F,  0,  0,  0,  1, TYPE_MEM), (0), (0)), IFLAGS_NONE),
  ( "se_stw"    , 0xD000, 0xDFFF, 3, INS_STORE, COND_AL, ((0x0F00,  6,  0,  0, 2, TYPE_MEM), (0x00F0,  4,  0,  0,  0, TYPE_REG_SE), (0x000F,  0,  0,  0,  1, TYPE_MEM), (0), (0)), IFLAGS_NONE),
