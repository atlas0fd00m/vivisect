...
#  ( "name"       , op        , mask                    , type   ,   op_type           , COND_AL, (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG))
  ...
  ( "e_lwz"      , 0x50000000, 0x53000000 | E_MASK_D   , E_D    ,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG_Z, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ( "e_lwzu"     , 0x18000200, 0x18000200 | E_MASK_D8  , E_D8   ,  INS_LOAD, COND_AL, (TYPE_REG, TYPE_MEM, TYPE_REG_Z, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
  ...
  ( "e_mr"       , 0x1800D000, 0x1800D000 | E_MASK_SCI8_2, E_SCI8_2, INS_MOV, COND_AL, (TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE), IFLAGS_NONE),
